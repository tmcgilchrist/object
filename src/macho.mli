...
(** [section_body macho segment section] returns a sub-buffer with the contents of the [section] of the MachO image in [Buffer.t].
 *)
val section_body : Buffer.t -> segment -> section -> Buffer.t
